...
CREATE TABLE "Producto_Old" (
    ...
    CONSTRAINT "Producto_Old_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "Stock" (
    ...
    "cantidadBobinas" INTEGER DEFAULT 0,
    "metrosInicialesPorBobina" DOUBLE PRECISION,
...
-- AddForeignKey
ALTER TABLE "Producto_Old" ADD CONSTRAINT "Producto_Old_clienteId_fkey" FOREIGN KEY ("clienteId") REFERENCES "Cliente"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Producto_Old" ADD CONSTRAINT "Producto_Old_fabricanteId_fkey" FOREIGN KEY ("fabricanteId") REFERENCES "Fabricante"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Producto_Old" ADD CONSTRAINT "Producto_Old_materialId_fkey" FOREIGN KEY ("materialId") REFERENCES "Material"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "PedidoItem" ADD CONSTRAINT "PedidoItem_productoId_fkey" FOREIGN KEY ("productoId") REFERENCES "Producto_Old"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "PresupuestoItem" ADD CONSTRAINT "PresupuestoItem_productoId_fkey" FOREIGN KEY ("productoId") REFERENCES "Producto_Old"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "PrecioEspecial" ADD CONSTRAINT "PrecioEspecial_productoId_fkey" FOREIGN KEY ("productoId") REFERENCES "Producto_Old"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Documento" ADD CONSTRAINT "Documento_productoId_fkey" FOREIGN KEY ("productoId") REFERENCES "Producto_Old"("id") ON DELETE SET NULL ON UPDATE CASCADE;
