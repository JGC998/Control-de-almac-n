...
-- Compatible con MariaDB (sin IF NOT EXISTS en constraints/índices)
-- ============================================================
...
ALTER TABLE `Producto`
  ADD INDEX `Producto_subfamiliaId_idx` (`subfamiliaId`);

ALTER TABLE `Producto`
  ADD CONSTRAINT `Producto_subfamiliaId_fkey`
...
ALTER TABLE `ArticuloSimple`
  ADD INDEX `ArticuloSimple_subfamiliaId_idx` (`subfamiliaId`);

ALTER TABLE `ArticuloSimple`
  ADD CONSTRAINT `ArticuloSimple_subfamiliaId_fkey`
    FOREIGN KEY (`subfamiliaId`) REFERENCES `Subfamilia` (`id`)
    ON DELETE SET NULL ON UPDATE CASCADE;
